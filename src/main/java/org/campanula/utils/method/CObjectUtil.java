...
public class CObjectUtil {
  ...
  public static <T> T get(Supplier<T> original, Supplier<T> nullOr) {
    if (original == null) throw new MethodNullException();
    T t = original.get();
    if (t == null)
        if (nullOr == null) throw new MethodNullException();
        else return nullOr.get();
    return t;
  }
  ...
  public static <T> T process(Supplier<T> original, Function<T, T> oNotNull, Supplier<T> oNull) {
    T t = get(original, null);
    if (t != null)
      if (oNotNull == null) throw new MethodNullException();
      else return oNotNull.apply(t);
    else
      if (oNull == null) throw new MethodNullException();
      else return oNull.get();
  }
  ...
  public static <T, R> R convert(Supplier<T> original, Function<T, R> oNotNull, Supplier<R> oNull) {
    ...
    if (t != null)
        ...
        else throw new MethodNullException();
    else
